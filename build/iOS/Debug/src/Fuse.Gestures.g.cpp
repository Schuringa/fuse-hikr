...
static void Scroller_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.0.2/$.uno");
...
{
    _delayStart = value;
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[7/*"Scroller.De...*/], this, ::STRINGS[2/*"/Users/jord...*/], 167, ::STRINGS[8/*"set_DelaySt...*/]);
}
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Invalid scr...*/], NULL, ::STRINGS[2/*"/Users/jord...*/], 481, ::STRINGS[3/*"OnUpdated"*/]);
        return;
    }
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"inconsisten...*/], NULL, ::STRINGS[2/*"/Users/jord...*/], 245, ::STRINGS[5/*"UpdatePoint...*/]);
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"inconsisten...*/], NULL, ::STRINGS[2/*"/Users/jord...*/], 252, ::STRINGS[5/*"UpdatePoint...*/]);
        else
        {
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Gestures/1.0.2/$.uno");
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[11/*"Element"*/], __this->Parent(), __this, ::STRINGS[12/*"/Users/jord...*/], 1158, ::STRINGS[13/*"OnRooted"*/]);
        return;
    }
