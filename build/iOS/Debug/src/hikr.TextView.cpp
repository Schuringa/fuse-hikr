// This file was generated based on /Users/jordans/code/research/fuse/hikr/.uno/ux11/hikr.TextView.g.uno.
...
{
    TextView::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 0);
    TextView::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Value"*/]);
}

static void TextView_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Value");
    ::STRINGS[1] = uString::Const("comments");
    ...
    type->SetInterfaces(
        ...
        ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/], offsetof(::g::Fuse::Controls::TextInputControl_type, interface4),
        ...
        ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(::g::Fuse::Controls::TextInputControl_type, interface8),
    ...
    type->SetFields(95,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::hikr::TextView, __g_nametable1), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::hikr::TextView, this_Value_inst), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::hikr::TextView::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::hikr::TextView::__selector0_, uFieldFlagsStatic);
}
...
uSStrong<uArray*> TextView::__g_static_nametable1_;
::g::Uno::UX::Selector TextView::__selector0_;
...
{
    this_Value_inst = ::g::hikr_FuseControlsTextInputControl_Value_Property::New1(this, TextView::__selector0());
    ::g::Fuse::Reactive::Data* temp = ::g::Fuse::Reactive::Data::New1(::STRINGS[1/*"comments"*/]);
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, TextView::__g_static_nametable1());
    ::g::Fuse::Controls::Rectangle* temp1 = ::g::Fuse::Controls::Rectangle::New3();
    ::g::Fuse::Reactive::DataBinding* temp2 = ::g::Fuse::Reactive::DataBinding::New1(this_Value_inst, (uObject*)temp, __g_nametable1, 3);
    TextWrapping(1);
    TextColor(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
    CaretColor(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
    Padding(::g::Uno::Float4__New2(5.0f, 5.0f, 5.0f, 5.0f));
    temp1->CornerRadius(::g::Uno::Float4__New2(4.0f, 4.0f, 4.0f, 4.0f));
    temp1->Color(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 0.1333333f));
    temp1->Layer(1);
