...
bool Pointer::ModifyCapture1(uObject* identity, ::g::Fuse::Visual* visual, uDelegate* lostCallback, int type, int pointIndex)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Capture can...*/], NULL, ::STRINGS[6/*"/Users/jord...*/], 1526, ::STRINGS[16/*"ModifyCapture"*/]);
        return false;
    }
    ...
    if (c != NULL)
    {
        if (uPtr(c)->Visual() != visual)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Cannot modi...*/], identity, ::STRINGS[6/*"/Users/jord...*/], 1537, ::STRINGS[16/*"ModifyCapture"*/]);
    }
    else
    {
