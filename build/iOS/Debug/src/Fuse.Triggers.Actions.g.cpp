...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.0.2/$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[3/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[4/*"/Users/jord...*/], 240, ::STRINGS[5/*"Perform"*/], NULL);
    else
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/1.0.2/$.uno");
    ::STRINGS[5] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"Requires a ...*/], __this, ::STRINGS[7/*"/Users/jord...*/], 283, ::STRINGS[5/*"Perform"*/], NULL);
        return;
    }
...
static void TimelineAction_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.0.2/actions/$.uno");
    ::STRINGS[5] = uString::Const("Perform");
    type->SetFields(8,
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"`TimelineAc...*/], __this, ::STRINGS[9/*"/Users/jord...*/], 827, ::STRINGS[5/*"Perform"*/], NULL);
        return;
    }
