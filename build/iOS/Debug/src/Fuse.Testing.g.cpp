...
{
    ::STRINGS[0] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Testing/1.0.2/$.uno");
...
{
    ::g::Uno::Testing::Assert::Fail(_message, ::STRINGS[0/*"/Users/jord...*/], 34, ::STRINGS[1/*"Fail"*/]);
}
