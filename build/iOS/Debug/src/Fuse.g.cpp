...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/$.uno
// ------------------------------------------------------------------------------------
...
static void Binding_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/$.uno");
...
{
    if (Parent() != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[2/*"double Bind...*/], this, ::STRINGS[3/*"/Users/jord...*/], 477, ::STRINGS[4/*"Root"*/]);
...
{
    if (Parent() == NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"double Bind...*/], this, ::STRINGS[3/*"/Users/jord...*/], 486, ::STRINGS[6/*"Unroot"*/]);
...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.2/$.uno
// -------------------------------------------------------------------------------------
...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Marshal/1.0.2/$.uno
// --------------------------------------------------------------------------------------
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/jord...*/], 581, ::STRINGS[22/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/jord...*/], 735, ::STRINGS[23/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/jord...*/], 647, ::STRINGS[31/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/jord...*/], 776, ::STRINGS[32/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/jord...*/], 820, ::STRINGS[33/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/jord...*/], 697, ::STRINGS[24/*"PopRenderTa...*/]);
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/jord...*/], 676, ::STRINGS[25/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Unpopped Sc...*/], this, ::STRINGS[3/*"/Users/jord...*/], 607, ::STRINGS[27/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Unpopped Cu...*/], this, ::STRINGS[3/*"/Users/jord...*/], 611, ::STRINGS[27/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[29/*"Unpopped Vi...*/], this, ::STRINGS[3/*"/Users/jord...*/], 615, ::STRINGS[27/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[30/*"Unpopped Re...*/], this, ::STRINGS[3/*"/Users/jord...*/], 619, ::STRINGS[27/*"ReleaseRoot...*/]);
...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.2/resources/$.uno
// -----------------------------------------------------------------------------------------------
...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[59] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Marshal/1.0.2/$.uno");
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[56/*"Cannot conv...*/], o), ::STRINGS[57/*"' to target...*/]), t), ::STRINGS[58/*"'"*/]), diagnosticSource, ::STRINGS[59/*"/Users/jord...*/], 654, ::STRINGS[60/*"TryConvertTo"*/], NULL);
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[72/*"AddContent ...*/], this, ::STRINGS[3/*"/Users/jord...*/], 3223, ::STRINGS[73/*"AddContent"*/]);
        return;
    }
    ...
    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[74/*"Could not l...*/], this, ::STRINGS[3/*"/Users/jord...*/], 3242, ::STRINGS[73/*"AddContent"*/]);
        return;
    }
...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.iOS/1.0.2/$.uno
// ----------------------------------------------------------------------------------
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[82] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.0.2/$.uno");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[81/*"UserEvent r...*/], __this, ::STRINGS[82/*"/Users/jord...*/], 654, ::STRINGS[83/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[86/*"Trying to R...*/], this, ::STRINGS[82/*"/Users/jord...*/], 701, ::STRINGS[87/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[84/*"Raise must ...*/], n, ::STRINGS[82/*"/Users/jord...*/], 421, ::STRINGS[80/*"raise"*/], NULL);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[85/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[82/*"/Users/jord...*/], 428, ::STRINGS[80/*"raise"*/], NULL);
        return;
    }
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[96/*"Invalid Rai...*/], 1, ::STRINGS[3/*"/Users/jord...*/], 1014);
            return;
        }
    }
...
{
    ::STRINGS[97] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[97/*"visual"*/]));
...
{
    ::STRINGS[98] = uString::Const("Wrapped Exception");
    type->SetFields(3);
}
...
{
    ctor_2(::STRINGS[98/*"Wrapped Exc...*/], inner);
}
