...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.0.2/$.uno
// ----------------------------------------------------------------------------------------
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.0.2/$.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[23/*"this.Contex...*/], ::STRINGS[24/*"/Users/jord...*/], 899, uArray::New(::TYPES[9/*object[]*/], 0));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[32/*"JavaScript ...*/], path), ::STRINGS[33/*" was fixed!"*/]), this, ::STRINGS[24/*"/Users/jord...*/], 1879, ::STRINGS[34/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[32/*"JavaScript ...*/], path), ::STRINGS[35/*" line "*/]), uBox<int>(::TYPES[45/*int*/], uPtr(e)->LineNumber())), ::STRINGS[36/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[24/*"/Users/jord...*/], 1889, ::STRINGS[34/*"Require"*/], NULL);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[43/*"Cannot call...*/], __this, ::STRINGS[24/*"/Users/jord...*/], 1582, ::STRINGS[44/*"Call"*/]);
            return *__retval = NULL, void();
        }
