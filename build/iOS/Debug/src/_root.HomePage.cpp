// This file was generated based on /Users/jordans/code/research/fuse/hikr/.uno/ux11/HomePage.g.uno.
...
static void HomePage_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("Pages/Home/HomePage.ux");
...
void HomePage::InitializeUX1()
{
    ...
    temp2->LineNumber(3);
    temp2->FileName(::STRINGS[3/*"Pages/Home/...*/]);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::hikr_bundle::HomePageb9b2d30f()));
