...
static void FuseControlsNative_bundle__cctor__fn(uType* __type)
{
    ...
    FuseControlsNative_bundle::iOSBlitter0a63f4bb_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[28/*"uniform vec...*/], ::STRINGS[29/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[7/*"f"*/]));
}
...
static void FuseControlsVideo_bundle_build(uType* type)
{
    ::STRINGS[37] = uString::Const("uniform float c, d, e, f, g, h, k, l, m, n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[38] = uString::Const("uniform sampler2D q;\n"
        "\n"
        "varying vec2 p;\n"
        "\n"
        "void main()\n"
    ...
    ::STRINGS[39] = uString::Const("uniform mat4 f, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[40] = uString::Const("uniform sampler2D h;\n"
        "\n"
        "varying vec2 g;\n"
        "\n"
        "void main()\n"
...
{
    FuseReactiveJavaScript_bundle::Diagnostics5dafd00d_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[147/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[148/*"diagnostics...*/]);
    FuseReactiveJavaScript_bundle::es6promisemine4793aac_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[147/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[149/*"es6-promise...*/]);
    FuseReactiveJavaScript_bundle::Observablef4970ad6_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[147/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[150/*"observable-...*/]);
    FuseReactiveJavaScript_bundle::setTimeoutca5ae254_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[147/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[151/*"settimeout-...*/]);
}
