...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/$.uno
// --------------------------------------------------------------------------------------------------
...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Expressions/1.0.2/$.uno
// ---------------------------------------------------------------------------------------------------
...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.2/$.uno
// ------------------------------------------------------------------------------------------------
...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[4/*"JavaScript ...*/], ex, this, ::STRINGS[5/*"/Users/jord...*/], 207, ::STRINGS[6/*"Call"*/]);
        }
        else throw __t;
    }
}
...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/fusejs/$.uno
// ---------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[12] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[12/*"/Users/jord...*/], 135);
    return NULL;
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"/Users/jord...*/], 121);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[32] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.2/$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[32/*"/Users/jord...*/], 409, ::STRINGS[34/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.2/subscription/$.uno
// -------------------------------------------------------------------------------------------------------------
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"/Users/jord...*/], 99);
...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Reactive/1.0.2/$.uno
// ---------------------------------------------------------------------------------------
...
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[41/*"Template co...*/], this, ::STRINGS[32/*"/Users/jord...*/], 1588, ::STRINGS[42/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Limit canno...*/], this, ::STRINGS[32/*"/Users/jord...*/], 1078, ::STRINGS[44/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"Offset cann...*/], this, ::STRINGS[32/*"/Users/jord...*/], 1030, ::STRINGS[46/*"set_Offset"*/], NULL);
        value = 0;
    }
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[48/*"JavaScript ...*/], FileName()), ::STRINGS[49/*" fixed!"*/]), this, ::STRINGS[5/*"/Users/jord...*/], 447, ::STRINGS[50/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                JavaScript::UserScriptError(::STRINGS[51/*"JavaScript ...*/], se, this, ::STRINGS[5/*"/Users/jord...*/], 463, ::STRINGS[50/*"EvaluateMod...*/]);
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[89/*"Unexpected ...*/], this, ::STRINGS[5/*"/Users/jord...*/], 646, ::STRINGS[90/*"SetExclusive"*/]);
        return;
    }
    ...
    catch (const uThrowable& __t)
    {
        ...
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[92/*"Failed to s...*/], ex, this, ::STRINGS[5/*"/Users/jord...*/], 661, ::STRINGS[90/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[95/*"Skipped Exc...*/], next, this, ::STRINGS[5/*"/Users/jord...*/], 1861, ::STRINGS[96/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[97/*"JavaScript ...*/], this, ::STRINGS[5/*"/Users/jord...*/], 1431, ::STRINGS[98/*"CreateMirror"*/]);
        return NULL;
    }
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[109/*"ThreadWorke...*/], e, this, ::STRINGS[5/*"/Users/jord...*/], 1757, ::STRINGS[110/*"Run"*/]);
