...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Double remo...*/], __this, ::STRINGS[3/*"/Users/jord...*/], 1742, ::STRINGS[17/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Unexpected ...*/], this, ::STRINGS[3/*"/Users/jord...*/], 1755, ::STRINGS[19/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.0.2/triggers/$.uno");
...
void Scrolled__OnRooted_fn(Scrolled* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"Scrolled co...*/], __this, ::STRINGS[22/*"/Users/jord...*/], 288, ::STRINGS[24/*"OnRooted"*/], NULL);
        return;
    }
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[21/*"check takes...*/], s, ::STRINGS[22/*"/Users/jord...*/], 242, ::STRINGS[20/*"check"*/], NULL);
        return;
    }
...
void State::Goto()
{
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Cannot call...*/], NULL, ::STRINGS[3/*"/Users/jord...*/], 2161, ::STRINGS[27/*"Goto"*/]);
        return;
    }
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[29/*"StateGroup....*/], n, ::STRINGS[3/*"/Users/jord...*/], 1825, ::STRINGS[30/*"goto_"*/], NULL);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[31/*"Unable to f...*/], name), n, ::STRINGS[3/*"/Users/jord...*/], 1805, ::STRINGS[32/*"gotoName"*/], NULL);
        return;
    }
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/jord...*/], 2587, ::STRINGS[39/*"playTo"*/], NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/jord...*/], 2636, ::STRINGS[41/*"seek"*/], NULL);
        return;
    }
...
static void TransitionGroup_build(uType* type)
{
    ...
    ::STRINGS[45] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/1.0.2/$.uno");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"Transition ...*/], t, ::STRINGS[45/*"/Users/jord...*/], 2777, ::STRINGS[46/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"Transition ...*/], t, ::STRINGS[45/*"/Users/jord...*/], 2784, ::STRINGS[46/*"Root"*/], NULL);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[48/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"/Users/jord...*/], 2930, ::STRINGS[49/*"Fuse.Animat...*/]);
        return;
    }
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[51/*"`Pulse` on ...*/], this, ::STRINGS[3/*"/Users/jord...*/], 4300, ::STRINGS[52/*"Pulse"*/]);
