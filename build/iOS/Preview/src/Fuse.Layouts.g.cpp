...
static void GridLayout_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Controls.Panels/1.0.2/layouts/$.uno");
...
void GridLayout::ModifyCount(uType* __type, uObject* list, int count, ::g::Fuse::Layouts::DefinitionBase* primordial)
{
    ...
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"RowCount an...*/], this, ::STRINGS[6/*"/Users/jord...*/], 1116, ::STRINGS[7/*"ModifyCount"*/], NULL);
        return;
    }
