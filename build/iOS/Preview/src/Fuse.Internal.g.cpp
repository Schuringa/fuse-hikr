...
// /Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.2/internal/$.uno
// ---------------------------------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.2/internal/$.uno");
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[5/*"ResampleMod...*/], this, ::STRINGS[3/*"/Users/jord...*/], 295, ::STRINGS[6/*"set_Resampl...*/]);
...
void ImageContainer::UpdateSourceListen(bool forceOff)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[2/*"Switching l...*/], this, ::STRINGS[3/*"/Users/jord...*/], 179, ::STRINGS[4/*"UpdateSourc...*/]);
