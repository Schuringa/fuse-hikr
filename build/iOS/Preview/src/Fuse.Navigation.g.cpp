...
void PageResourceBinding::ctor_3(::g::Uno::UX::Property1* target, uString* key)
{
    ...
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[24/*"PageResourc...*/], this, ::STRINGS[1/*"/Users/jord...*/], 1644, ::STRINGS[25/*".ctor"*/]);
...
Route* Route::SubDepth(int count)
{
    ...
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[31/*"count can't...*/], this, ::STRINGS[1/*"/Users/jord...*/], 2039, ::STRINGS[32/*"SubDepth"*/]);
        return NULL;
    }
...
void Router::CancelNavigation()
{
    ...
    if (_prepareOutlet != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[50/*"No active n...*/], NULL, ::STRINGS[1/*"/Users/jord...*/], 2944, ::STRINGS[51/*"CancelNavig...*/]);
}
...
::g::Fuse::Navigation::Route* Router::GetRelativeRoute(::g::Fuse::Node* from, ::g::Fuse::Navigation::Route* rel)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Cannot calc...*/], this, ::STRINGS[1/*"/Users/jord...*/], 3142, ::STRINGS[55/*"GetRelative...*/], NULL);
        return NULL;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Did not fin...*/], this, ::STRINGS[1/*"/Users/jord...*/], 3149, ::STRINGS[55/*"GetRelative...*/], NULL);
        return NULL;
    }
...
void Router::Modify(int how, ::g::Fuse::Navigation::Route* route, int mode, uString* operationStyle)
{
    ...
    switch (how)
    {
        ...
        {
            if (route != NULL)
                ::g::Fuse::Diagnostics::UserWarning(::STRINGS[64/*"PrepareBack...*/], this, ::STRINGS[1/*"/Users/jord...*/], 2764, ::STRINGS[65/*"Modify"*/]);

            if (uPtr(_history)->Count() == 0)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[66/*"There is no...*/], this, ::STRINGS[1/*"/Users/jord...*/], 2768, ::STRINGS[65/*"Modify"*/], NULL);
                return;
            }
...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[73/*"Cannot pop(...*/], this, ::STRINGS[1/*"/Users/jord...*/], 2846, ::STRINGS[74/*"Pop"*/], NULL);
        return;
    }
...
void Router::SetPrepareProgress(double value)
{
    ...
    if ((pc == NULL) || (pn == NULL))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[75/*"Invalid out...*/], this, ::STRINGS[1/*"/Users/jord...*/], 2925, ::STRINGS[76/*"SetPrepareP...*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, uString* operationStyle, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        ...
        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"/Users/jord...*/], 2962, ::STRINGS[78/*"SetRoute"*/], NULL);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"/Users/jord...*/], 2964, ::STRINGS[78/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation, uString* operationStyle, uObject** majorChange)
{
    ...
    *majorChange = NULL;
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[79/*"No router o...*/], r), this, ::STRINGS[1/*"/Users/jord...*/], 2983, ::STRINGS[80/*"SetRouteImpl"*/]);
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[81/*"SubRoute re...*/], r), this, ::STRINGS[1/*"/Users/jord...*/], 3009, ::STRINGS[80/*"SetRouteImpl"*/]);
            return NULL;
        }
        else
        {
...
void Router::Bookmark(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[41/*"`Router.boo...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2344, ::STRINGS[42/*"Bookmark"*/], NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"`Router.boo...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2351, ::STRINGS[42/*"Bookmark"*/], NULL);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[44/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"Could not f...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2375, ::STRINGS[42/*"Bookmark"*/], NULL);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[46/*"path"*/]))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"`path` shou...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2384, ::STRINGS[42/*"Bookmark"*/], NULL);
                return;
            }
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[48/*"Unrecognize...*/], p), r, ::STRINGS[1/*"/Users/jord...*/], 2392, ::STRINGS[42/*"Bookmark"*/], NULL);
            return;
        }
    }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"A `name` is...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2405, ::STRINGS[42/*"Bookmark"*/], NULL);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::GetRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[52/*"Router.goto...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2153, ::STRINGS[53/*"GetRelative"*/], NULL);
        return NULL;
    }
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[57/*"Router.getR...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2497, ::STRINGS[58/*"GetRoute"*/], NULL);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[59/*"Router.getR...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2503, ::STRINGS[58/*"GetRoute"*/], NULL);
        return;
    }
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[60/*"Router.goBa...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2198, ::STRINGS[61/*"GoBack"*/], NULL);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[62/*"Router.goto...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2102, ::STRINGS[63/*"Goto"*/], NULL);
}
...
void Router::Modify1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"`Router.mod...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2241, ::STRINGS[65/*"Modify"*/], NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"`Router.mod...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2248, ::STRINGS[65/*"Modify"*/], NULL);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[46/*"path"*/]))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"`path` shou...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2272, ::STRINGS[65/*"Modify"*/], NULL);
                return;
            }
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[44/*"relative"*/]))
        {
            ...
            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"Could not f...*/], r, ::STRINGS[1/*"/Users/jord...*/], 2284, ::STRINGS[65/*"Modify"*/], NULL);
                return;
            }
        }
        ...
        else if (::g::Uno::String::op_Equality(p, ::STRINGS[33/*"bookmark"*/]))
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[71/*"Unknown boo...*/], bk), r, ::STRINGS[1/*"/Users/jord...*/], 2297, ::STRINGS[65/*"Modify"*/], NULL);
                return;
            }
        }
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[48/*"Unrecognize...*/], p), r, ::STRINGS[1/*"/Users/jord...*/], 2307, ::STRINGS[65/*"Modify"*/], NULL);
            return;
        }
    }
...
bool Router::ValidateParameter(::g::Fuse::Scripting::Context* c, uObject* arg, int depth)
{
    ...
    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[82/*"Route param...*/], NULL, ::STRINGS[1/*"/Users/jord...*/], 2416, ::STRINGS[83/*"ValidatePar...*/], NULL);
        return false;
    }
    ...
    if (uIs(arg, ::TYPES[39/*Fuse.Scripting.Object*/]))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[84/*"Route param...*/], NULL, ::STRINGS[1/*"/Users/jord...*/], 2425, ::STRINGS[83/*"ValidatePar...*/], NULL);
            return false;
        }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[85/*"Route param...*/], NULL, ::STRINGS[1/*"/Users/jord...*/], 2448, ::STRINGS[83/*"ValidatePar...*/], NULL);
        return false;
    }
...
void RouterCancelNavigation__Perform_fn(RouterCancelNavigation* __this, ::g::Fuse::Node* n)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[86/*"Router not ...*/], __this, ::STRINGS[1/*"/Users/jord...*/], 3231, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
void RouterModify__Perform_fn(RouterModify* __this, ::g::Fuse::Node* n)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[86/*"Router not ...*/], __this, ::STRINGS[1/*"/Users/jord...*/], 3355, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
    ...
    if (::g::Uno::String::op_Inequality(__this->Bookmark(), NULL))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[71/*"Unknown boo...*/], __this->Bookmark()), __this, ::STRINGS[1/*"/Users/jord...*/], 3365, ::STRINGS[2/*"Perform"*/], NULL);
            return;
        }
    }
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[87/*"Seek being ...*/], __this, ::STRINGS[1/*"/Users/jord...*/], 3784, ::STRINGS[88/*"Fuse.Naviga...*/]);
        return;
    }
...
void StructuredNavigation::Duration(double value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[93/*"Use a `Navi...*/], this, ::STRINGS[1/*"/Users/jord...*/], 3686, ::STRINGS[94/*"set_Duration"*/]);
}
...
void StructuredNavigation::Easing(::g::Fuse::Animations::Easing* value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[95/*"Use a `Navi...*/], this, ::STRINGS[1/*"/Users/jord...*/], 3677, ::STRINGS[96/*"set_Easing"*/]);
}
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[89/*"Attempting ...*/], element, ::STRINGS[1/*"/Users/jord...*/], 3493, ::STRINGS[90/*"GotoImpl"*/], NULL);
        SetActive(NULL);
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[97/*"Motion shou...*/], this, ::STRINGS[1/*"/Users/jord...*/], 3420, ::STRINGS[98/*"set_Motion"*/], NULL);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[91/*"Updated cal...*/], this, ::STRINGS[1/*"/Users/jord...*/], 3584, ::STRINGS[92/*"OnUpdated"*/]);
        return;
    }
...
void SwipeNavigate::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (_currentNavigation == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[99/*"SwipeNaviga...*/], 1, ::STRINGS[1/*"/Users/jord...*/], 4134);
        return;
    }
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[101/*"Navigation....*/], nav, ::STRINGS[1/*"/Users/jord...*/], 4587, ::STRINGS[102/*"gotoNode"*/], NULL);
}
// }
...
void WhileHistoryTrigger__OnRooted_fn(WhileHistoryTrigger* __this)
{
    ...
    if (__this->NavigationContext() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[103/*"WhileHistor...*/], __this, ::STRINGS[1/*"/Users/jord...*/], 4858, ::STRINGS[7/*"OnRooted"*/], NULL);
        return;
    }
...
void WhileNavigating__OnRooted_fn(WhileNavigating* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[104/*"WhileNaviga...*/], __this, ::STRINGS[1/*"/Users/jord...*/], 4956, ::STRINGS[7/*"OnRooted"*/], NULL);
        return;
    }
...
void WhilePageActive__OnRooted_fn(WhilePageActive* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[105/*"Must be use...*/], __this, ::STRINGS[1/*"/Users/jord...*/], 5271, ::STRINGS[7/*"OnRooted"*/], NULL);
        return;
    }
