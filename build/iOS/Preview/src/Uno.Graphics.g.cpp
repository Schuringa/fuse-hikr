...
static void Texture2D_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/jordans/Library/Application Support/Fusetools/Packages/UnoCore/1.0.11/source/uno/graphics/$.uno");
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[4/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[5/*"**** Invali...*/], versionString), 1, ::STRINGS[6/*"/Users/jord...*/], 975);
            }
            else throw __t;
        }
    }
